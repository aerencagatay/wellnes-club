...
export function HeroHome() {
  ...
  return (
    <section className="relative flex min-h-[85vh] items-end overflow-hidden bg-dark">
      <Image alt="" className="object-cover" fill priority sizes="100vw" src="/img/venue/hero.webp" />
      <div aria-hidden className="absolute inset-0 bg-dark/40" />
      <div className="container-page relative pt-32 pb-20 md:pb-28">
        ...
        <h1 className="type-display max-w-3xl text-background">{t('title')}</h1>
        <p className="mt-6 max-w-xl text-base leading-relaxed text-background/90 md:text-lg">{t('lede')}</p>
